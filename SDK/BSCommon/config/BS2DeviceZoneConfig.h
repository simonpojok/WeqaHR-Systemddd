#ifndef BS2DEVICEZONECONFIG_H
#define BS2DEVICEZONECONFIG_H
 ...
 */
enum {
    BS2_DEVICE_ZONE_ALARMED_DISALARM			= 0x00, //Disalarmed ����
    BS2_DEVICE_ZONE_ALARMED_ALARM 				= 0x01, //Alarm�� ���, Master�� Fire Alarm Alarmed/Disalarmed ���¸� ������ �� �����̴�. Self �� �� ���°� �Ǹ� ������ Master���� ������ �ʾƵ� �ȴ�.
    BS2_DEVICE_ZONE_ALARMED_SELF				= 0x02, //Self�� ���, �ڽ��� Alarmed ���������� Master���� Fire Alarm Detected ������ ���� ���޵��� ���� �����̴�. �� ��� �ֱ������� ������ Master���� ������ �Ѵ�.
};
